...
import type { UserDTO as _UserDTO, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteUserData(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllUserData(): Promise<Array<UserDTO>> {
        if (this.processError) {
            try {
    ...
    async getUserData(arg0: string): Promise<UserDTO | null> {
        if (this.processError) {
            try {
    ...
    async saveUserData(arg0: UserDTO): Promise<UserDTO> {
        if (this.processError) {
            try {
                const result = await this.actor.saveUserData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserData(arg0: string, arg1: UserDTO): Promise<UserDTO> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserDTO]): UserDTO | null {
    return value.length === 0 ? null : value[0];
}
